...
torchrun $DISTRIBUTED_ARGS finetune.py  \
    ...
    --max_steps 10000 \
    --eval_steps 1000 \
    --output_dir ../output/output_minicpmv26_0820 \
    --logging_dir ../output/output_minicpmv26_0820 \
