...
# Load model
# model_path = '/mnt/ceph2/pretrained/openbmb/MiniCPM-V-2_6/'
model_path = '/mnt/ceph2/MiniCPM-V-main/output/output_minicpmv26/checkpoint-10000/'
...
# launch
demo.launch(share=False, debug=True, show_api=False, server_port=8885, server_name="10.33.10.63")
