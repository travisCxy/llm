...
class varyQwenModel(Qwen2Model):
    ...
    def __init__(self, config: Qwen2Config):
        ...
        self.mm_projector = nn.Linear(1024, 512)
        self.mm_projector_vary = nn.Linear(1024, 512)
    ...
    def initialize_vision_modules(
        ...
        self.vision_tower_high = build_sam_vit_b(checkpoint='/mnt/ceph2/pretrained/facebook/sam_vit_b_01ec64.pth')
