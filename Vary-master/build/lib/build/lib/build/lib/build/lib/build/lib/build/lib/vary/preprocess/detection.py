...
def detect_tiku(parallel):
    files = glob('/mnt/ceph2/datasets/tiku4/images0/**/*.jpg', recursive=True)
    files += glob('/mnt/ceph2/datasets/tiku4/images0-2/**/*.jpg', recursive=True)
    files += glob('/mnt/ceph2/datasets/tiku4/images_split/**/*.jpg', recursive=True)
    print(len(files))
