...
from vary.model.plug.transforms import train_transform, train_transform2
...
class BaseDataset(Dataset):
    ...
    def image_processor(self, image, mode):
        ...
        # else:
        #     image_high = train_transform(image_high)
        image_high = train_transform2(image_high)
