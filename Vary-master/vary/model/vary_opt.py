...
class varyOPTModel(OPTModel):
    ...
    def __init__(self, config: OPTConfig):
        ...
        # self.vision_tower = build_sam_vit_l()
    ...
    def initialize_vision_modules(
        ...
        # self.vision_tower = build_sam_vit_l(checkpoint='/mnt/ceph2/pretrained/facebook/sam_vit_l_0b3195.pth')
        self.vision_tower = build_sam_vit_l(checkpoint='/mnt/ceph2/Vary/runs/05212/vision_tower_high.pth')
