...
def prepare_tiku(tokenizer, parallel):
    ...
    if parallel:
        process_parallel(process, files, tokenizer, True, True, progress_queue, '/mnt/ceph2/datasets/tiku/vary/conversations_tiku_det10_3.json')
    else:
...
if __name__ == "__main__":
    ...
    # with open('/mnt/ceph2/datasets/tiku/vary/conversations_tiku_det10_2.json', 'w', encoding='utf-8') as f:
