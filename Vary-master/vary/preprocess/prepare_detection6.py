...
def prepare_imgs():
    files = glob('/mnt/ceph2/datasets/tiku4/words*/**/*.docx', recursive=True)
    files += glob('/mnt/ceph2/datasets/tiku5/words*/**/*.docx', recursive=True)
    # for path in files:
...
def prepare_tiku(tokenizer, parallel):
    ...
    # files = ['/mnt/ceph2/datasets/tiku2/words0/小学/山东/2021-2022学年山东省济宁市微山县一年级（下）期末数学试卷_1341089_数学_2.docx']
    print(len(files))
    progress_queue = multiprocessing.Queue()
    if parallel:
        process_parallel(process, files, tokenizer, True, True, progress_queue, '/mnt/ceph2/datasets/tiku/vary/conversations_tiku_det14.json')
    else:
...
if __name__ == "__main__":
    ...
    # files = glob('/mnt/ceph2/datasets/tiku2/words*/**/*.docx', recursive=True)
    # print(len(files))
    # counts = {}
    # for path in files:
