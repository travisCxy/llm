...
from vary.model.vary_qwen2_vary import (
    varyQwenForCausalLM as OldVaryQwenForCausalLM,
)
from awq.modules.fused.norm import FasterTransformerRMSNorm


class VaryAWQForCausalLM(BaseAWQForCausalLM):
    layer_type = "Qwen2DecoderLayer"
    max_seq_len_key = "max_position_embeddings"

    @staticmethod
    def fuse_layers(model: OldVaryQwenForCausalLM):
        fuser = Qwen2Fuser(model)
        fuser.fuse_transformer()

    @staticmethod
    def get_model_layers(model: OldVaryQwenForCausalLM):
    ...
    @staticmethod
    def move_embed(model: OldVaryQwenForCausalLM, device: str):
        model.model.embed_tokens = model.model.embed_tokens.to(
            device
        )
...
class Qwen2Fuser:
    def __init__(self, model: OldVaryQwenForCausalLM):
        self.model = model
